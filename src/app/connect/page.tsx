...
export const metadata: Metadata = {
  ...
  description: `Follow Palms Place updates, office NAP, and social channels for Las Vegas Strip high-rise condos—with ${siteContact.agentName}, ${siteContact.brokerage}.`,
