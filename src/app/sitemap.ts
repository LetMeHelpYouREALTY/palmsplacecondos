...
const PATHS: { path: string; changeFrequency: ChangeFrequency; priority: number }[] = [
  ...
  { path: "/guide/palms-place-hoa-and-monthly-costs", changeFrequency: "monthly", priority: 0.87 },
  { path: "/guide/furnished-palms-place-condos", changeFrequency: "monthly", priority: 0.86 },
  { path: "/guide/palms-place-amenities-and-resort-access", changeFrequency: "monthly", priority: 0.86 },
  { path: "/area/palms-place-las-vegas", changeFrequency: "monthly", priority: 0.88 },
